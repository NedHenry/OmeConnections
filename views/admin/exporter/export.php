...
foreach($elementArray as $elementSetName => $elements)
  {
    ...
    $eSSlug=getElementSetSlug($elementSetName);
    
    echo '<METS:mdWrap ';
    echo 'ID="MDW_ITEM'.$itemID.'_'.$eSSlug.'" ';
    //echo 'MIMETYPE="'..'" ';
    echo 'LABEL="'.$elementSetName.'" ';
    if(is_type_other($eSSlug))
      {
	echo 'MDTYPE="OTHER" ';
	//echo 'MDTYPEVERSION="'..'" ';
	$eSSlug = "";
...
function getElementSetSlug($elementSetName)
{
